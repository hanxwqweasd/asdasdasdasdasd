...
const schema=z.object({
  ...
  SENTRY_DSN:optionalUrl,SENTRY_TRACES_SAMPLE_RATE:z.coerce.number().min(0).max(1).default(.1),ENABLE_METRICS:bool(true),METRICS_TOKEN:z.string().min(16).optional(),APP_VERSION:z.string().default('2.0.4'),
